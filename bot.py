...
Стиль общения:
- Пиши развёрнуто, минимум 1-3 предложения в ответе
...
TASK_SUFFIX = "\n\nОтветь на последнее сообщение. Будь живой и интересной — развей тему, пошути или задай вопрос. Пиши развёрнуто, минимум 2-4 предложения!"
...
class Bot(commands.Bot):
    ...
    async def check_silence_loop(self):
        await self.wait_for_ready()
        silence_prompts = [
            "Задай интересный вопрос чату про игры, фильмы или что-то актуальное. Без приветствий, сразу к делу. Пиши развёрнуто!",
            "Скажи что-то смешное или поделись мыслью чтобы разговорить чат. Можно задать вопрос. Пиши развёрнуто!",
            "Напиши что-нибудь интересное чтобы начать общение. Поделись историей или задай вопрос. Пиши развёрнуто!",
        ]
        while True:
