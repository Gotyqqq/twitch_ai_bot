...
# Массовые реакции (если 3+ человека написали одно и то же)
MASS_REACTION_THRESHOLD = 3
MASS_REACTION_EMOTES = ['LUL', 'KEKW', 'PogChamp', 'Pog', 'OMEGALUL']
